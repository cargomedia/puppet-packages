...
describe cron do
  it { should have_entry '* * * * * cd /etc/puppet/repos/puppet-packages && git fetch --quiet --tags origin && git checkout --quiet 6297f205d6e410c0d1b51d05af9f9f41394412be && git merge --quiet --ff-only origin 6297f205d6e410c0d1b51d05af9f9f41394412be' }
end
